...
export class CoursesService {
  public courses: ICourse[] = [
    {
      ...
      topRated: false,
      description:
        `The course provides you with understanding of how to model your own RESTFull APIs application based on Spring Boot ` +
    ...
    },
    {
      ...
      topRated: true,
      description:
        `On this training, we will take a look at custom components in Angular, what they are, how to build components in ` +
    ...
    },
    {
      ...
      topRated: false,
      description:
        `This training is about Angular 2 directives and pipes. It covers pipes purpose, build-in pipes usage and custom ` +
  ...
  public removeItem(items: ICourse[], id: number): ICourse[] {
    const updatedItems: ICourse[] = items.filter(
